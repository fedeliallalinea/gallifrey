...
SRC_URI="amd64? ( mirror://sourceforge/project/jasperstudio/JaspersoftStudio-${PV}/${MY_PN}_${PV}.final_linux_x86_64.tgz )
	x86? ( mirror://sourceforge/project/jasperstudio/JaspersoftStudio-${PV}/${MY_PN}_${PV}.final_linux_x86.tgz )"
LICENSE="EPL-1.0"
IUSE=""
SLOT="0"
KEYWORDS="~amd64 ~x86"
