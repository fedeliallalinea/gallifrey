...
SRC_URI="x86? ( https://trials.sencha.com/cmd/$(ver_cut 1-3)/no-jre/SenchaCmd-${PV}-linux-i386.sh.zip )
	amd64? ( https://trials.sencha.com/cmd/$(ver_cut 1-3)/no-jre/SenchaCmd-${PV}-linux-amd64.sh.zip )
"
