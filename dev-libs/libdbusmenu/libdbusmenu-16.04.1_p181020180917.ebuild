...
MY_PV="${PV/_p*/}+${PV:9:2}.${PV:11:2}.${PV:13}"

DESCRIPTION="Library to pass menu structure across DBus"
HOMEPAGE="https://launchpad.net/dbusmenu"
SRC_URI="https://launchpad.net/ubuntu/+archive/primary/+sourcefiles/${PN}/${MY_PV}-0ubuntu1/${PN}_${MY_PV}.orig.tar.gz"
