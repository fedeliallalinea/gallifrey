...
src_prepare() {
	default
	sed -i -e "s:/usr/share/dbeaver/dbeaver\.png:${MY_PN}:" \
		-e "s:/usr/share/dbeaver/dbeaver:/usr/bin/${MY_PN}:" \
		-e "s:/usr/share/dbeaver:/opt/${MY_PN}:" dbeaver.desktop || die "failed to change .desktop"
}
...
src_install() {
	...
	newmenu dbeaver.desktop "${MY_PN}.desktop"
}
