...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils mozconfig-kde-v6.55 pax-utils fdo-mime autotools virtualx mozlinguas-kde-v2 mercurial
...
IUSE="bindist +gmp-autoupdate hardened hwaccel jack kde nsplugin pgo selinux test"
