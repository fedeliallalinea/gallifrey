...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils mozconfig-kde-v6.59 \
...
IUSE="bindist eme-free +gmp-autoupdate hardened hwaccel jack kde nsplugin +screenshot selinux test"
